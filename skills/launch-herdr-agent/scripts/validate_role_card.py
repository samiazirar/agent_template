...
CONTRACTS = {
    ...
    "worker": (
        "ROLE: Worker",
        "MODEL: Native Codex GPT-5.6 Luna max for normal coding; native Codex Sol medium for harder coding; explicitly selected OpenCode GLM 5.2 or Opus 5 alternative",
